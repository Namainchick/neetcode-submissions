...
# how the fuck did i solve that first try. Its not pretty but it works. First run worked directly 
# without looking at the test output. this is brute force tho lets try it better next time. by getting half then 
# sorting last half and merging correctly 
